...
const ecosystem: EcosystemCategory[] = [
  ...
  },
  {
    ...
    brands: ["Gallagher", "HID Global", "Suprema", "IDEMIA", "Honeywell", "Johnson Controls", "Bosch", "dormakaba", "LenelS2", "Hikvision", "Virdi", "Timewatch", "tyco", "Rosslare"],
  ...
  },
  {
    ...
    brands: ["Bosch", "Honeywell", "Notifier", "Siemens", "Johnson Controls", "Edwards", "EST", "GST"],
  ...
  },
  {
    ...
    brands: ["Bosch", "Honeywell", "TOA", "Bose Professional", "Apogee", "Sennheiser", "M-Audio", "Ahuja", "Yamaha", "Ravel"],
  ...
  },
  {
    ...
    brands: ["Cisco", "HPE Aruba Networking", "Ruckus", "Juniper Networks", "Fortinet", "Sophos", "D-Link", "3Com"],
  ...
  },
  {
    ...
    brands: ["HPE", "Dell Technologies", "Lenovo", "NetApp", "Synology", "Western Digital", "Seagate", "Sony", "Barco", "ATEN", "Tegile", "Samsung", "APC", "Vertiv", "Brother"],
  ...
  },
  {
    ...
    brands: ["dormakaba", "Smiths Detection", "Gunnebo", "Gallagher", "Boon Edam", "Rapiscan Systems", "Nemtek", "Park Zeus"],
