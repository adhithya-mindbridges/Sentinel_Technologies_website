...
const categories: SolutionCategory[] = [
  ...
  },
  {
    ...
    tagline: "Engineering the Technologies of Tomorrow.",
    intro:
      "Sentinel X-Labs is our innovation and R&D initiative focused on emerging technologies for industrial, infrastructure, security and autonomous applications.",
    items: [
