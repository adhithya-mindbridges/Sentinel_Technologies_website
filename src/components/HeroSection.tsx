...
import { Shield, CheckCircle, ArrowRight, Camera, Lock, Users } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-primary hover:bg-primary-dark text-white px-8 py-4 text-lg rounded-lg shadow-security transition-all duration-300 hover:scale-105">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-security">
                <div className="text-2xl font-bold text-primary">500+</div>
                <div className="text-sm text-muted-foreground">Projects Completed</div>
              </div>
              
              <div className="absolute -top-6 -right-6 bg-white p-4 rounded-xl shadow-security">
