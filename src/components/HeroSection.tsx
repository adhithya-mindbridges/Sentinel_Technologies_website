        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <LogoMotif className="pointer-events-none absolute -top-10 -right-10 w-40 h-40 text-white/10 -z-10 hidden lg:block" />
              <img
                src={heroImage}
              ...
              >
                <div className="text-2xl font-bold text-primary">{getStat("Projects").value}</div>
              ...
              >
                <div className="text-2xl font-bold text-primary">{getStat("Years").value}</div>
        ...
        <div className="mt-20 pt-12 border-t border-white/20">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-white/80">Operational Support</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2">3×</div>
              <div className="text-white/80">ISO Certified</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2">{getStat("Partners").value}</div>
              <div className="text-white/80">Technology Partners</div>
            </div>
            <div>
